...
'''
Using Semi-supervised learning algorithm
But this version will emphasize on the multi-label nature of the clustering problem
'''
...
def run(seed_names, seed_points, query_names, query_points, alg, kernel, alpha, nn, gamma):
    ...
    # for point in predicted_probs:
    #     print(sorted(point, key=lambda x: -x))
