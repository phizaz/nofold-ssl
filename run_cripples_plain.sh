...
python -u -m src.clustering --tag=rfam75id-rename.cripple20 --alg=labelSpreading --kernel=rbf --alpha=0.7 --gamma=0.4 
python -u -m src.cluster_refinement --tag=rfam75id-rename.cripple20 --alg=labelSpreading --c=1.0 
...
python -u -m src.clustering --tag=rfam75id-rename.cripple15 --alg=labelSpreading --kernel=rbf --alpha=0.7 --gamma=0.4 
python -u -m src.cluster_refinement --tag=rfam75id-rename.cripple15 --alg=labelSpreading --c=1.0 
...
python -u -m src.clustering --tag=rfam75id-rename.cripple10 --alg=labelSpreading --kernel=rbf --alpha=0.7 --gamma=0.4 
python -u -m src.cluster_refinement --tag=rfam75id-rename.cripple10 --alg=labelSpreading --c=1.0 
...
python -u -m src.clustering --tag=rfam75id-rename.cripple5 --alg=labelSpreading --kernel=rbf --alpha=0.7 --gamma=0.4 
python -u -m src.cluster_refinement --tag=rfam75id-rename.cripple5 --alg=labelSpreading --c=1.0 
...
python -u -m src.clustering --tag=rfam75id-rename.cripple2 --alg=labelSpreading --kernel=rbf --alpha=0.7 --gamma=0.4 
python -u -m src.cluster_refinement --tag=rfam75id-rename.cripple2 --alg=labelSpreading --c=1.0 
...
python -u -m src.clustering --tag=rfam75id-rename.cripple0 --alg=labelSpreading --kernel=rbf --alpha=0.7 --gamma=0.4 
python -u -m src.cluster_refinement --tag=rfam75id-rename.cripple0 --alg=labelSpreading --c=1.0 
